...
class _ChildLoginScreenState extends State<ChildLoginScreen> {
                      ...
                      _LabeledField(
                        ...
                        child: TextFormField(
                          ...
                          validator: (v) {
                            ...
                            if (!rx.hasMatch(v.trim())) return 'صيغة البريد غير صحيحة';
                            return null;
                          },
  ...
  if (_formKey.currentState?.validate() ?? false) {
    // بعد نجاح التحقق — افتح شاشة الطوارئ
    Navigator.pushReplacement(
      ...
      MaterialPageRoute(builder: (_) => const EmergencyScreen()),
                          ...
                          child: const Text('دخول', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w800)),
                        ),
                      ),
                    ],
                  ),
